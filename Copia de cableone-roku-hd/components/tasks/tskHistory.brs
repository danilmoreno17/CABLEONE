    ...
    ?"add init"
        ...
        m.simpleTask.user = m.top.user
        m.simpleTask.password = m.top.password
    ...
    sub addToFav()
        ...
        url = m.top.url + m.top.accountID + "/history?token=" + token
        ?"Creating history"
        ?url
        result = CallApiPost(url)
    end sub
...
sub convertirANodo(objeto as Object, nodeCategory as Object )
    ...
    function CallApiPOST(url As Object) as Object
       'print
        ut = CreateObject("roUrlTransfer")
        'print url.EncodeUri()
        ...
        arr = di.GetConnectionInfo()
        m.top.macAddr = arr["mac"]
        strPostJSON = "{" + chr(34) + "account" + chr(34) + ":" + chr(34) + m.top.accountID  + chr(34) + ","
        strPostJSON = strPostJSON +  chr(34) +  "userId" + chr(34) + ":" + chr(34) +m.top.userID + chr(34) + ","
        strPostJSON = strPostJSON +  chr(34) +  "deviceId" + chr(34) + ":" + chr(34) +m.top.macAddr + chr(34) + ","        
        strPostJSON = strPostJSON +  chr(34) +  "contentId" + chr(34) + ":" + chr(34) +m.top.macAddr + chr(34) + ","   
        strPostJSON = strPostJSON +  chr(34) +  "name" + chr(34) + ":" + chr(34) + m.top.macAddr + chr(34) + ","                      
        strPostJSON = strPostJSON +  chr(34) +  "metadata" + chr(34) + ":{" + chr(34) + "type" + chr(34) + ":" + chr(34) + "movie" + chr(34)  + "},"        
        strPostJSON = strPostJSON +  chr(34) +  "tags" + chr(34) + ":[" + chr(34) + "history" + chr(34) + "]}"        
        ut.SetCertificatesFile("common:/certs/ca-bundle.crt")
        ut.SetRequest("POST")
        ut.InitClientCertificates()
        ut.AsyncPostFromString(FormatJson("strPostJSON"))
        ut.SetUrl(url.EncodeUri())
        'SetUpUrlTransferObject(ut)
        res = ParseJson(ut.GetToString())
        'res = ParseJson(ut.GetToString())
